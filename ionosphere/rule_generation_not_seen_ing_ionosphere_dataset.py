...
from sample_enumerate_abstraction_pedagogical_ing_ionosphere_dataset import *
...
if __name__ == "__main__":
    ...
    np.save(other_data_name+'/ionosphere_x_train.npy', X_train)
    np.save(other_data_name+'/ionosphere_y_train.npy', Y_train)
    
    np.save(other_data_name+'/ionosphere_x_test.npy', X_test)
    
    np.save(other_data_name+'/ionosphere_y_test.npy', Y_test)
...
# %%
    ...
    np.save(other_data_name+'/logical_rules_inosphere_data.npy',ruleSet)
