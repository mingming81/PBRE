...
for epoch in range(num_epochs):
    ...
    for step in range(0,steps):
        ...
        if step==0:
            ...
            # each user state does not change for one hour
            if step%12==0:
                x_us_t=X_us_t_generation()
            x_us_t=x_us_t.reshape((1,-1))
        ...
        transition=(x_light_t_norm,actions,reward_t,x_light_t_new_norm,x_le_t_new)
...
np.save('./../v3/'+other_data_name+'/replayMemory_light_service_structure_2_v9_100_unseen.npy',LightService.replayMemory)

np.save('./../v3/'+other_data_name+'/totalEpochRewards_light_service_structure_2_v9_100_unseen.npy',totalEpochRewards)
