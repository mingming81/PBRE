...
np.save('./../v3/'+other_data_name+'/replayMemory_light_service_structure_2_v7_100_unseen.npy',LightService.replayMemory)

np.save('./../v3/'+other_data_name+'/totalEpochRewards_light_service_structure_2_v7_100_unseen.npy',totalEpochRewards)
