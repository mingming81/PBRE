...
lightService.lightServiceModel.load_state_dict(torch.load('./../v3/'+other_data_name+'/lightService_light_lstm_v2_sig.pth'))
lightService.targetLightServiceModel.load_state_dict(torch.load('./../v3/'+other_data_name+'/lightService_light_lstm_v2_sig.pth'))
