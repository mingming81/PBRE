...
from sample_enumerate_abstraction_pedagogical_ing_single_service_light_v1_v9_p1 import *
...
class LightService:
    ...
    def __init__(self,beta=100,power=60,deta_t=5/60,ReplayMemorySize=1000000,
        ...
        self.LightServiceModel.load_state_dict(torch.load('./../v3/'+dirName+f'/single_service_light_v3_55_v9.pth'))
        ...
        self.targetLightServiceModel.load_state_dict(torch.load('./../v3/'+dirName+f'/single_service_light_v3_55_v9.pth'))
    ...
    def getActionsRule(self,x_light_t_norm):
        ...
        x_ls_new_t=torch.tensor([[x_ls_new_t]])  
        x_cur_new_t=torch.tensor([[x_cur_new_t]])
...
logicalRules=np.load('./../v3/'+other_data_name+'/logical_rules_light_service_structure_2_v9_100.npy',allow_pickle=True)
print(f"extracted rule shape: {logicalRules.shape}")

LightService.setRules(logicalRules)

replayMemory=np.load('./../v3/'+other_data_name+'/replayMemory_light_service_structure_2_v9_100_unseen.npy',allow_pickle=True)
...
numericalEpochReward=np.load('./../v3/'+other_data_name+'/totalEpochRewards_light_service_structure_2_v9_100_unseen.npy',allow_pickle=True)
...
np.save('./../v3/'+other_data_name+'/totalEpochRewards_light_service_structure_2_v9_decomp_RULES_100_unseen.npy',totalEpochRewards)

np.save('./../v3/'+other_data_name+'/replayMemory_light_service_structure_2_v9_decomp_RULES_100_unseen.npy',LightService.replayMemory)

np.save('./../v3/'+other_data_name+'/notseen_states_light_service_structure_2_v9_decomp_RULES_100_unseen.npy',notSeenStates)
