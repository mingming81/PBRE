...
# totalEpochRewardsNN=np.load('./../v3/'+other_data_name+'/totalEpochRewards_light_lstm_seen.npy',allow_pickle=True)
# replayMemoryNN=np.load('./../v3/'+other_data_name+'/replayMemory_light_lstm_seen.npy',allow_pickle=True)

# totalEpochRewardsRule=np.load('./../v3/'+other_data_name+'/totalEpochRewards_light_service_structure_lstm_RULES_100_seen.npy',allow_pickle=True)
# replayMemoryRule=np.load('./../v3/'+other_data_name+'/replayMemory_light_service_structure_lstm_RULES_100_seen.npy',allow_pickle=True)
# notSeenStatesRule=np.load('./../v3/'+other_data_name+'/notseen_states_light_service_structure_lstm_RULES_100_seen.npy',allow_pickle=True)


totalEpochRewardsNN=np.load('./../v3/'+other_data_name+'/totalEpochRewards_light_lstm_unseen.npy',allow_pickle=True)
replayMemoryNN=np.load('./../v3/'+other_data_name+'/replayMemory_light_lstm_unseen.npy',allow_pickle=True)

totalEpochRewardsRule=np.load('./../v3/'+other_data_name+'/totalEpochRewards_light_service_structure_lstm_RULES_100_unseen.npy',allow_pickle=True)
replayMemoryRule=np.load('./../v3/'+other_data_name+'/replayMemory_light_service_structure_lstm_RULES_100_unseen.npy',allow_pickle=True)
notSeenStatesRule=np.load('./../v3/'+other_data_name+'/notseen_states_light_service_structure_lstm_RULES_100_unseen.npy',allow_pickle=True)
...
# np.save('./../v3/'+other_data_name+f'/totalEpochRewards_light_service_structure_lstm_NN_100_seen.npy',totalEpochRewardsNN)  
# np.save('./../v3/'+other_data_name+f'/replayMemory_light_service_structure_lstm_NN_100_seen.npy',replayMemoryNN)  
# np.save('./../v3/'+other_data_name+f'/seenEpochRewards_light_service_structure_lstm_100_seen.npy',seenEpochRewards) 
# np.save('./../v3/'+other_data_name+f'/idx_light_service_structure_lstm_100_seen.npy',idx_seen) 
# np.save('./../v3/'+other_data_name+f'/idx_light_service_structure_lstm_100_2_seen.npy',idx_seen_2)  

np.save('./../v3/'+other_data_name+f'/totalEpochRewards_light_service_structure_lstm_NN_100_unseen.npy',totalEpochRewardsNN)  
np.save('./../v3/'+other_data_name+f'/replayMemory_light_service_structure_lstm_NN_100_unseen.npy',replayMemoryNN)  
np.save('./../v3/'+other_data_name+f'/seenEpochRewards_light_service_structure_lstm_100_unseen.npy',seenEpochRewards) 
np.save('./../v3/'+other_data_name+f'/idx_light_service_structure_lstm_100_unseen.npy',idx_seen) 
np.save('./../v3/'+other_data_name+f'/idx_light_service_structure_lstm_100_2_unseen.npy',idx_seen_2) 
