...
from sample_enumerate_abstraction_pedagogical_ing_single_service_light_v2_v7 import *
...
totalEpochRewards=np.load('./../v3/'+other_data_name+'/totalEpochRewards_light_service_structure_2_v7_100_seen.npy',allow_pickle=True)

replayMemory=np.load('./../v3/'+other_data_name+'/replayMemory_light_service_structure_2_v7_100_seen.npy',allow_pickle=True)
...
if __name__ == "__main__":
    ...
    model.load_state_dict(torch.load('./../v3/'+dirName+f'/single_service_light_v1_v7.pth'))
    ...
    np.save('./../v3/'+other_data_name+'/logical_rules_light_service_structure_2_v7_100_d10.npy',ruleSet)
