...
# %%
    ...
    if epoch%100==0 and epoch!=0:    
        ...
        torch.save(lightService.lightServiceModel.state_dict(),dirName+f'/lightService_light_lstm_v2_{1+int(epoch/100)}_sig.pth')
        np.save(dirName+f'/totalEpochRewards_light_lstm_v2_{1+int(epoch/100)}_sig.npy',totalEpochRewards)


torch.save(lightService.lightServiceModel.state_dict(),dirName+'/lightService_light_lstm_v2_sig.pth')
np.save(dirName+f'/totalEpochRewards_light_lstm_v2_sig.npy',totalEpochRewards)
